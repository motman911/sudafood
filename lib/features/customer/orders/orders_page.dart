...
// ✅ استيراد الشاشات والمكونات الموحدة
...
class OrdersPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return DefaultTabController(
      ...
      child: Scaffold(
        ...
        body: TabBarView(
          children: [
            // قائمة الطلبات التي لا تزال قيد التنفيذ (pending, preparing, ready, delivering)
            _buildFirestoreOrderList(context, isActive: true),
            // قائمة الطلبات المنتهية (completed, cancelled)
  ...
  // ✅ جلب البيانات الحقيقية من Firebase لحظياً
  Widget _buildFirestoreOrderList(BuildContext context,
    ...
    return StreamBuilder<QuerySnapshot>(
      stream: FirebaseFirestore.instance
          ...
          // فلترة الحالات بناءً على التبويب المختار يدوياً
          .where('status',
              whereIn: isActive
      ...
      builder: (context, snapshot) {
        ...
        return ListView.builder(
          ...
          itemBuilder: (context, index) {
            // تحويل البيانات من Firestore إلى موديل OrderModel
                ...
                children: [
                  ...
                  Column(
                    ...
                    children: [
                      ...
                      Text(_getStatusArabicText(order.status),
                          style: TextStyle(
                              fontSize: 12,
  ...
  // دوال مساعدة لترجمة الحالة وتلوينها يدوياً
